...
1. **配置环境**（30分钟）
   ...
   - 安装Claude Code CLI
   - 配置VSCode Remote-WSL
   - 参考：[1-环境相关.md](1-环境相关.md)

2. **了解基础概念**（15分钟）
   - 阅读[0-基本知识.md](0-基本知识.md)
   - 了解Prompt、Token、Context Window

3. **快速入门实践**（30分钟）
   - 跟随[2-ClaudeCode快速入门.md](2-ClaudeCode快速入门.md)
   - 尝试第一个对话
   - 执行第一个Skill（如项目提供）
...
4. **切换模型**：
   - 简单任务可使用更快的模型
   - 参考：[0-基本知识.md](0-基本知识.md)

**相关文档**：[2-ClaudeCode快速入门.md](2-ClaudeCode快速入门.md)
...
1. **查看更详细的文档**：
   - [1-环境相关.md](1-环境相关.md) - 环境配置详解
   - [2-ClaudeCode快速入门.md](2-ClaudeCode快速入门.md) - 入门教程
   - [3-Skill使用指南.md](3-Skill使用指南.md) - Skill使用详解

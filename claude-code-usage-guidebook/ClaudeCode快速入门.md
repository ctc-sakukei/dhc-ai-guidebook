...
开始使用前，请确保已完成：
- ✅ 环境配置（参考 [010-环境相关.md](010-环境相关.md)）
...
> **Skill是什么？** 预定义的可复用任务脚本，类似于"快捷指令"。详见 [基本知识.md#skill技能](基本知识.md#skill技能)
...
> 📖 **深入学习**：Skill的完整使用指南、决策方法、故障排查等，请查看 [Skill使用指南.md](Skill使用指南.md)
...
**入门路径（按顺序学习）：**
1. [Skill使用指南.md](Skill使用指南.md) - 深入学习Skill使用
3. [入门常见问题FAQ.md](入门常见问题FAQ.md) - 遇到问题时查阅

**进阶学习（掌握基础后）：**
- [核心概念.md](核心概念.md) - 深入了解Claude Code的工作机制
- [使用技巧.md](使用技巧.md) - 掌握实用技巧和最佳实践
- [成本与安全.md](成本与安全.md) - 成本控制和高级技巧
